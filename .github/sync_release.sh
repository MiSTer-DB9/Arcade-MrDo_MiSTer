...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-MrDo_MiSTer.git"
CORE_NAME=(Arcade-MrDo)
...
UPSTREAM_CORE_NAME=(Arcade-MrDo)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-MrDo.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-MrDo.rbf)
